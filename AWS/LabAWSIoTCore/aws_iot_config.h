...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a30mv68jy0zfa-ats.iot.eu-west-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "Device1" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "Device1" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "d1203cfd1f-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "d1203cfd1f-private.pem.key" ///< Device private key filename
// =================================================

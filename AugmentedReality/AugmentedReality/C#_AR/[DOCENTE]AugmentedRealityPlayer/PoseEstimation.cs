...
namespace AugmentedRealityPlayer
{
    ...
    class PoseEstimation
    {
        ...
        public void Execute()
        {
            ...
            CoplanarPosit coposit = new CoplanarPosit(markerModelCornerPoints, ImageWidth);
            Matrix3x3 rotationMatrix;
            Vector3 translationVector;
            coposit.EstimatePose(newMarkerCornerPoints, out rotationMatrix, out translationVector);

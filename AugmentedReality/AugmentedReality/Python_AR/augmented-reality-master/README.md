************************************************************************
The code has been slightly modified  to be executed in jupyter notebook.
See the source code MarkerLessAR.ipynb in 'src' folder

The original readme file by the author Juan Gallostra Acín is reported below, with instructions and comments in order to execute the code in a python environment.

Print on a sheet the file model.jpg included in the folder 'reference' 
***********************************************************************
# augmented-reality
